...
require.define("/js/jquery-1.7.2.min.js",function(require,module,exports,__dirname,__filename,process){/*! jQuery v1.7.2 jquery.com | jquery.org/license */
...
require.define("/js/jquery.isotope.js",function(require,module,exports,__dirname,__filename,process){/**
 * Isotope v1.5.19
...
// ========================= Isotope ===============================
  ...
  $(".options-open, .options-close").click(function () {
    $(this)
    .parents(".options")
  ...
  // primitive flash effect for logo border

  // var flash = function () {
  //   $(this)
  //   .parents()
  //   .children(".logo-container")
  //   .children(".effect")
  ...
  // $(".clicks, .trades, .kudos").click(flash); 

  $(".links > .about").click( function () {
    $("p.target").slideToggle().fadeToggle
  });

})( window, jQuery );
});

require.define("/js/jquery.maskedinput.js",function(require,module,exports,__dirname,__filename,process){/*
...
require.define("/js/chosen.jquery.min.js",function(require,module,exports,__dirname,__filename,process){// Chosen, a Select Box Enhancer for jQuery and Protoype
...
require.define("/moment.js",function(require,module,exports,__dirname,__filename,process){// moment.js
// version : 1.6.2
// author : Tim Wood
// license : MIT
// momentjs.com
(function (Date, undefined) {
  var moment, VERSION = "1.6.2",
    round = Math.round,
    i,
  ...
  moment.utc = function (input, format) {
    ...
    return (format && input) ? moment(input + ' +0000', format + ' Z').utc() : moment(input && !parseTokenTimezone.exec(input) ? input + '+0000' : input).utc();
  };
  ...
  moment.lang = function (key, values) {
    ...
    if (languages[key]) {
      for (i = 0; i < langConfigProperties.length; i++) {
        moment[langConfigProperties[i]] = languages[key][langConfigProperties[i]] || languages.en[langConfigProperties[i]];
      }
      currentLanguage = key;
    } else {
      if (hasModule) {
  ...
  moment.fn = Moment.prototype = {
    ...
    sod: function () {
      return moment(this).hours(0).minutes(0).seconds(0).milliseconds(0);
    },
    eod: function () {
...
require.define("/js/scripts.js",function(require,module,exports,__dirname,__filename,process){/* require ('./jquery-1.7.2.min.js') */
